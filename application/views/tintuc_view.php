	...
	<div class="bread">
		<div class="wrap">
			<div class="breadcrumb">
				<a href="<?= base_url()?>">Trang chủ</a> &raquo; <a href="<?= base_url('tin-tuc.html') ?>" >Tin tức</a>
			</div>
		</div>
	</div>
	<!----Bread-->
		...
		<div class="wrap">
			<div class="box productTeaserBox prd-row">
				...
				<div class="content spen-plus">
					<h1><span class="arrow-icon"></span>&nbsp;Tin tức</h1>
						...
						<div class="denews">
							<ul id="denews">
								...
								<li>
									...
									<h3><a href="<?= base_url('tin-tuc/'.$getAlltuyendung['seo_name'].'.html') ?>"><?= stripslashes($getAlltuyendung['newsTitle']) ?></a></h3>
									...
									<a href="<?= base_url('tin-tuc/'.$getAlltuyendung['seo_name'].'.html') ?>"> Xem tiếp </a></div>
								</li>
