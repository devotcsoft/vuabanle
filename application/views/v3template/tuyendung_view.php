...
<section id="main-page">
    ...
    <article id="content-page">
        ...
        <div id="main-news">
        	<?php $i = 0; foreach($getAlltuyendungs as $getAlltuyendung): ?>
            <div class="news-item <?php if(($i%3) == 0) { echo "last"; }?>">
                <h2 class="title"><a href="<?= base_url('tuyen-dung/'.$getAlltuyendung['seo_name'].'.html') ?>"><?= $getAlltuyendung['newsTitle'] ?></a></h2>
                <!-- 
                <div class="function">
