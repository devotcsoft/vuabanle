...
<div id="content">
  ...
  <div class="wrap">
     ...
     <div id="registrat">
		...
		<h2><span class="fontawesome-lock"></span>Sửa thông tin thành viên</h2>

		<form action="<?php echo base_url().'thanh-vien/sua-thong-tin-thanh-vien';?>" method="POST">

			<fieldset>
				<p>Email : <?php echo  $memberdetail['email'];?>
				 				
				<p><label for="HoTen">Họ và Tên (*) </label>
				<input name="fullname" type="HoTen" id="HoTen" value="<?php echo  $memberdetail['fullname'];?>" /></p> 
					<p><label for="SDT">Số Điện Thoại (*) </label>
				<input name="phone" type="SDT" id="SDT" value="<?php echo  $memberdetail['phone'];?>" /></p> 
				<?php echo form_error('fullname'); ?>
				<?php echo form_error('phone'); ?>
				<p><input type="submit" id="add" value="Cập nhập"></p>
