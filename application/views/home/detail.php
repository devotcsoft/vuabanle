...
<a class="navAllCat " href="#"> Danh mục sản phẩm </a>
<a class="navDropdown" href="#"></a>
<div class="navSub-wrapper">
<ul class="navSub">
<li class="multiMenu"  data-sub-menu="navLayer_1">
<a class="catArrow " href="#"> <span class="navSubTxt">Đồ dùng gia đình</span> </a>
</li>
<li class="multiMenu"  data-sub-menu="navLayer_2">
<a class="catArrow " href="#"> <span class="navSubTxt">Điện lạnh, Điều hòa </span> </a>
</li>
<li class="multiMenu"  data-sub-menu="navLayer_3">
<a class="catArrow " href="#"> <span class="navSubTxt">Thể thao, Du lịch, Nghe nhìn </span> </a>
</li>
<li class="multiMenu" data-sub-menu="navLayer_4">
<a class="catArrow " href="#"> <span class="navSubTxt">Sắc đẹp, Sức khỏe </span> </a>
</li>
<li class="multiMenu" data-sub-menu="navLayer_5">
<a class="catArrow " href="#"> <span class="navSubTxt">Máy văn phòng</span> </a>
</li>
<li class="multiMenu"  data-sub-menu="navLayer_6">
<a class="catArrow " href="#"> <span class="navSubTxt">Đồ dùng, Đồ chơi trẻ em</span> </a>
</li>
<li class="multiMenu"  data-sub-menu="navLayer_7">
<a class="catArrow " href="#"> <span class="navSubTxt">Xe đạp các loại </span> </a>
</li>
<li class="multiMenu"  data-sub-menu="navLayer_8">
<a class="catArrow " href="#"> <span class="navSubTxt">Máy chấm đọc, máy học tiếng anh </span> </a>
</li>
...
<div class="nav-title"><a href="#">TiVi,Video &amp; Âm Thanh</a> </div>
														...
														<a href="#" class="bsncLink">Quạt điện</a>
																...
																<a href="#" class="bsncLink">Máy trồng rau</a>
																		...
																		<a href="#" class="bsncLink">Nồi hấp đa năng</a>
																				...
																				<!-- Image in .png format -->
																						<a href="#"> <span class="" data-src="<?= base_url('public/font-end')?>/images/anh-thu-muc-do-dung-gia-dinh.jpg"><img src="<?= base_url('public/font-end')?>/images/anh-thu-muc-do-dung-gia-dinh.jpg"></span> </a> </div>
...
<div id="content">
  ...
  <div class="wrap">
     <div id="registrat">
		...
		<h2><span class="fontawesome-lock"></span>Thông tin thành viên</h2>

		<form action="" method="POST">
		
			<fieldset>
				<p>Tên Đăng Nhập:  <?php echo $memberdetail->userName; ?></p>
				<p>Họ và Tên :  <?php echo $memberdetail->fullname; ?> </p>
				<p>Số Điện Thoại:  <?php echo $memberdetail->phone; ?></p>
				<p>Email:  <?php echo $memberdetail->email; ?></p>
			
				<a href="<?php echo base_url().'thanh-vien/doi-mat-khau'?>">Đổi mật khẩu</a></br>
				<a href="<?php echo base_url().'thanh-vien/sua-thong-tin-thanh-vien'?>">Sửa thông tin cá nhân</a>
		</fieldset>
		</form>
	</div> <!-- end login -->
