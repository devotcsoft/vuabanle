...
<div id="content">
  ...
  <div class="wrap">
     ...
     <div id="registrat">
		...
		<h2><span class="fontawesome-lock"></span>Đổi mật khẩu</h2>

		<form action="<?php echo base_url().'thanh-vien/doi-mat-khau';?>" method="POST">

			<fieldset>
				<p><label for="TDN">Mật khẩu cũ: </label>
				<input name="pass-old" type="password" id="TDN"  /></p> 
