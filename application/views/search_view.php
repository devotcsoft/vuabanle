...
function getlist()
{
	 $.ajax({
         ...
         success: function (response) {
             ...
             htmlString += '<button title="Close (Esc)" type="button" class="close" id="close"></button>';
             //console.log(count);
                                    ...
                                    <div class="categoryMenu filter-cancel box-bdr box-bgcolor fsm">
                                        ...
                                        <div class="fct-list fct-list-browse_by">
                                            <div>
                                                ...
                                                <a class="fct-cancel" href="<?= base_url().'search'.'-pd-pr0'?><?php if(isset($Catebrand) && $Catebrand != ""){ echo '-th'.$Catebrand; }else { echo '-th0';} ?>-tt<?php if(isset($CateTt) && $CateTt != ""){ echo $CateTt; }else { echo 0;} ?>-od<?php if(isset($CateOrder) && $CateOrder != ""){ echo $CateOrder; }else { echo 0;} ?>"> <span class="fct-cancel__type">Loại sp:</span>
                                                ...
                                                <a class="fct-cancel" href="<?= base_url().'search';  ?><?php if(isset($CateParent) && $CateParent != ""){ echo '-pd-pr'.$CateParent; }else { echo '-pd-pr0';} ?><?php echo '-th0'; ?>-tt<?php if(isset($CateTt) && $CateTt != ""){ echo $CateTt; }else { echo 0;} ?>-od<?php if(isset($CateOrder) && $CateOrder != ""){ echo $CateOrder; }else { echo 0;} ?>"> <span class="fct-cancel__type">Thương hiệu sp:</span>
                                                ...
                                                <a class="fct-cancel" href="<?= base_url().'search';  ?><?php if(isset($CateParent) && $CateParent != ""){ echo '-pd-pr'.$CateParent; }else { echo '-pd-pr0';} ?><?php if(isset($Catebrand) && $Catebrand != ""){ echo '-th'.$Catebrand; }else { echo '-th0';} ?>-tt0-od<?php if(isset($CateOrder) && $CateOrder != ""){ echo $CateOrder; }else { echo 0;} ?>"> <span class="fct-cancel__type">Hàng:</span>
                                                     <?php 
                                                        if($CateTt == 1)
                                                        {
                                                            echo "Sản phẩm mới";
                                            ...
                                            <a class="rfloat fct__cancell-all-link" href="<?php echo base_url('search') ?>">Xoá tất cả</a>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="filter selected orderby">
                                        <div class="filter-name ">
                                            <?php if(isset($CateOrder) && $CateOrder == 1){ ?>
                                                <a href="<?= base_url().'search' ?><?php if(isset($CateParent) && $CateParent != ""){ echo '-pd-pr'.$CateParent; }else { echo '-pd-pr0';} ?><?php if(isset($Catebrand) && $Catebrand != ""){ echo '-th'.$Catebrand; }else { echo '-th0';} ?><?php if(isset($CateTt) && $CateTt != ""){ echo '-tt'.$CateTt; }else { echo '-tt0';} ?>-od1">Giá thấp đến cao</span></a>
                                            <?php }else { ?>
                                                <a href="<?= base_url().'search' ?><?php if(isset($CateParent) && $CateParent != ""){ echo '-pd-pr'.$CateParent; }else { echo '-pd-pr0';} ?><?php if(isset($Catebrand) && $Catebrand != ""){ echo '-th'.$Catebrand; }else { echo '-th0';} ?><?php if(isset($CateTt) && $CateTt != ""){ echo '-tt'.$CateTt; }else { echo '-tt0';} ?>-od2">Giá cao đến thấp</span></a>
                                            <?php }
                                            ?>
                                        </div>
                                        <div class="filter-list-wrapper">
                                            <ul class="filter-list nolist ">
                                                <li <?php if(isset($CateOrder) && $CateOrder == 1){ echo 'class="checked"';} ?> >
                                                    <a href="<?= base_url().'search' ?><?php if(isset($CateParent) && $CateParent != ""){ echo '-pd-pr'.$CateParent; }else { echo '-pd-pr0';} ?><?php if(isset($Catebrand) && $Catebrand != ""){ echo '-th'.$Catebrand; }else { echo '-th0';} ?><?php if(isset($CateTt) && $CateTt != ""){ echo '-tt'.$CateTt; }else { echo '-tt0';} ?>-od1<?php if(isset($_GET['price_from']) && isset($_GET['price_to'])){ echo '?price_from='.$_GET['price_from'].'&price_to='.$_GET['price_to']; } ?>">Giá thấp đến cao</span></a>
                                                </li>
                                                <li <?php if(isset($CateOrder) && $CateOrder == 2){ echo 'class="checked"';} ?> >
                                                    <a href="<?= base_url().'search' ?><?php if(isset($CateParent) && $CateParent != ""){ echo '-pd-pr'.$CateParent; }else { echo '-pd-pr0';} ?><?php if(isset($Catebrand) && $Catebrand != ""){ echo '-th'.$Catebrand; }else { echo '-th0';} ?><?php if(isset($CateTt) && $CateTt != ""){ echo '-tt'.$CateTt; }else { echo '-tt0';} ?>-od2<?php if(isset($_GET['price_from']) && isset($_GET['price_to'])){ echo '?price_from='.$_GET['price_from'].'&price_to='.$_GET['price_to']; }?>">Giá cao đến thấp</span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
