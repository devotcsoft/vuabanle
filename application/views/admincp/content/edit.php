	...
	<div class="workplace">
		<div class="row-fluid">
			<div class="span12">
				...
				<form accept-charset="utf-8" method="post"  id="contact" action="<?php echo base_url('admincp/content/edit').'/'.$cateDetail->newsID;?>">
					...
					<div class="block-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" placeholder="Tên bài viết" class="required"  value="<?= $cateDetail->newsTitle ?>"
						...
						<div class="row-form">
							...
							<div class="span9">
								<select name="tieudiemID">
									<option value="0" <?php if($cateDetail->tieudiemID != "1"){ echo "selected = selected";}?>>Không thuộc menu Top</option>
									<option value="1" <?php if($cateDetail->tieudiemID == "1"){ echo "selected = selected";}?>>MenuTop</option>
								</select>
							</div>
							<div class="clear"></div>
						</div>
						...
						<div class="row-form">
							...
							<div class="span9">
								<select name="icon">
									...
									<option value="ship_on" <?php if($cateDetail->tieudiemID == "icon"){ echo "selected = selected";}?>>Ship hàng</option>
									<option value="return_money" <?php if($cateDetail->tieudiemID == "icon"){ echo "selected = selected";}?>>Trả lại tiền</option>
								</select>
							</div>
							<div class="clear"></div>
						</div>
