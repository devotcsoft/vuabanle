	...
	<div class="workplace">
		<div class="row-fluid">
			<div class="span12">
				...
				<form accept-charset="utf-8" method="post"  id="contact" action="<?php echo base_url('admincp/services/edit').'/'.$cateDetail->newsID;?>">
					...
					<div class="block-fluid">
						...
						<div class="row-form">
							<div class="span3">Tên dịch vụ</div>
							<div class="span9">
								<input type="text" placeholder="nhập tên dịch vụ" class="required"  value="<?= $cateDetail->newsTitle ?>"
