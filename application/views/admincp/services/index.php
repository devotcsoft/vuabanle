...
-->
    ...
    <div class="content">
        <div class="breadLine">
            ...
            <ul class="buttons">
				<li>
					<a href="<?php echo base_url()."admincp/services/add"?>"><span class="icon-plus"></span><span class="text">Thêm mới</span></a>
				</li>
				<li>
        ...
        <div class="row-fluid">
                ...
                <div class="span12">
        			<form accept-charset="utf-8" method="post" action="<?= base_url('admincp/services') ?>" id="formserchproduc">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">                    
                    ...
                    <div class="block-fluid table-sorting">
	                    <form accept-charset="utf-8" method="post" action="<?php echo base_url()."admincp/services/delete"?>" id="formListCate">
                            ...
                            <tbody>
                                ...
                                <?php foreach($content as $idx => $val){?>
									<tr class="<?= $idx % 2 == 0? 'odd': 'event'  ?>>">
										...
										<td><?=  $val['newsID']  ?></td>
										<td><a href="<?php echo base_url('admincp/services/edit');?>/<?= $val['newsID'] ?>"><?= $val['newsTitle'] ?></a></td>
										<td><?= $val['seo_name'] ?></td>
