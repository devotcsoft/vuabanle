	...
	<div class="workplace">
		<div class="row-fluid">
			<div class="span12">
				...
				<form accept-charset="utf-8" method="post"  id="contact" action="<?php echo base_url('admincp/news/add');?>">
					<div class="block-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" placeholder="Tên tin tức" class="required"  value=""
						...
						<div class="row-form">
							<div class="span3">Tiêu điểm</div>
							<div class="span9">
								<select name="tieudiemID">
									<option value="0">Không thuộc</option>
									<option value="1">Thuộc menu</option>
								</select>
							</div>
							<div class="clear"></div>
						</div>
