...
-->
    ...
    <div class="content">
        <div class="breadLine">
            ...
            <ul class="buttons">
				<li>
					<a href="<?php echo base_url()."admincp/brand/add"?>"><span class="icon-plus"></span><span class="text">Thêm mới</span></a>
				</li>
				<li>
        ...
        <div class="workplace">
         <div class="row-fluid">
                ...
                <div class="span12"> 
        	<form accept-charset="utf-8" method="post" action="<?= base_url('admincp/brand') ?>" id="formserchproduc">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">                    
                    ...
                    <div class="block-fluid table-sorting">
	                    <form accept-charset="utf-8" method="post" action="<?php echo base_url()."admincp/brand/delete"?>" id="formListCate">
                            ...
                            <tbody>
                                ...
                                <?php foreach($brand as $idx => $val){?>
									<tr class="<?= $idx % 2 == 0? 'odd': 'event'  ?>>">
										...
										<td><?=  $val['catID']  ?></td>
										<td><a href="<?php echo base_url('admincp/brand/edit');?>/<?= $val['catID'] ?>"><?= $val['catName'] ?></a></td>
										<td><?= $val['keypage'] ?></td>
										<td>
											<?php if(isset($val['catImage']) && $val['catImage'] != ""){ ?>
												<img src="<?= base_url().$val['catImage'] ?>" width="79px" height="59px"/>		
											<?php } ?>
										<div>
