...
-->
    ...
    <div class="content">
        <div class="breadLine">
            ...
            <ul class="buttons">
				<li>
					<a href="<?php echo base_url()."admincp/works/add"?>"><span class="icon-plus"></span><span class="text">Thêm mới</span></a>
				</li>
				<li>
        ...
        <div class="workplace">
         <div class="row-fluid">
                ...
                <div class="span12">
        	<form accept-charset="utf-8" method="post" action="<?= base_url('admincp/works') ?>" id="formserchproduc">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">                    
                    ...
                    <div class="block-fluid table-sorting">
	                    <form accept-charset="utf-8" method="post" action="<?php echo base_url()."admincp/works/delete"?>" id="formListCate">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                            <thead>
                                <tr>
                                    ...
                                    <th width="5%">ID</th>
                                    <th width="40%">Tiêu đề tuyển dụng</th>
                                    <th width="30%">URL SEO</th>
                            ...
                            <tbody>
                                ...
                                <?php foreach($content as $idx => $val){?>
									<tr class="<?= $idx % 2 == 0? 'odd': 'event'  ?>>">
										...
										<td><?=  $val['newsID']  ?></td>
										<td><a href="<?php echo base_url('admincp/works/edit');?>/<?= $val['newsID'] ?>"><?= $val['newsTitle'] ?></a></td>
										<td><?= $val['seo_name'] ?></td>
