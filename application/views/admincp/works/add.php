	...
	<div class="workplace">
		<div class="row-fluid">
			<div class="span12">
				...
				<form accept-charset="utf-8" method="post"  id="contact" action="<?php echo base_url('admincp/works/add');?>">
					<div class="block-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" placeholder="Tiêu đề tuyển dụng" class="required"  value=""
